...
def build_model(train_loader,test_loader,pred_loader):
    ...
    for e in range(1, EPOCHS + 1):
        ...
        torch.save(model, '/home/studio-lab-user/eCommerce Conversion Rate Improvement/MODEL/eCommerce_ConversionRate')
    return model,device
...
def pred_model(device,scaler):
    model = torch.load('/home/studio-lab-user/eCommerce Conversion Rate Improvement/MODEL/eCommerce_ConversionRate')
